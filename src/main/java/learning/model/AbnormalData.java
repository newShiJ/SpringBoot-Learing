...
public class AbnormalData implements Serializable {
    ...
    /**
     * 异常数据来源的类名，注意是Java dal Entity的名字
     */
    ...
    /**
     * 异常数据来源的类名，注意是Java dal Entity的名字
     * @return class_name 异常数据来源的类名，注意是Java dal Entity的名字
     */
    ...
    /**
     * 异常数据来源的类名，注意是Java dal Entity的名字
     * @param className 异常数据来源的类名，注意是Java dal Entity的名字
     */
    ...
    /**
     * 签名字段
     * @param signatureField 签名字段
     */
    public void setSignatureField(String signatureField) {
        this.signatureField = signatureField == null ? null : signatureField.trim();
    }

    /**
     * 原值（一般是金额）
     * @return value 原值（一般是金额）
     */
    ...
    public boolean equals(Object that) {
        ...
        AbnormalData other = (AbnormalData) that;
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
            ...
            && (this.getSignatureField() == null ? other.getSignatureField() == null : this.getSignatureField().equals(other.getSignatureField()))
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getSignatureField() == null) ? 0 : getSignatureField().hashCode());
    ...
    public String toString() {
        ...
        sb.append(", signatureField=").append(signatureField);
