...
public class MessageRec implements Serializable {
    ...
    /**
     * 消息接收实体标识
     * @return message_rec_code 消息接收实体标识
     */
    public String getMessageRecCode() {
        return messageRecCode;
    }

    /**
     * 消息接收实体标识
     * @param messageRecCode 消息接收实体标识
     */
    public void setMessageRecCode(String messageRecCode) {
        this.messageRecCode = messageRecCode == null ? null : messageRecCode.trim();
    }
    ...
    public boolean equals(Object that) {
        ...
        MessageRec other = (MessageRec) that;
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
            ...
            && (this.getMessageRecCode() == null ? other.getMessageRecCode() == null : this.getMessageRecCode().equals(other.getMessageRecCode()))
            && (this.getReadTime() == null ? other.getReadTime() == null : this.getReadTime().equals(other.getReadTime()))
            && (this.getRecUserCode() == null ? other.getRecUserCode() == null : this.getRecUserCode().equals(other.getRecUserCode()))
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getMessageRecCode() == null) ? 0 : getMessageRecCode().hashCode());
        result = prime * result + ((getReadTime() == null) ? 0 : getReadTime().hashCode());
        result = prime * result + ((getRecUserCode() == null) ? 0 : getRecUserCode().hashCode());
    ...
    public String toString() {
        ...
        sb.append(", messageRecCode=").append(messageRecCode);
        sb.append(", readTime=").append(readTime);
        sb.append(", recUserCode=").append(recUserCode);
