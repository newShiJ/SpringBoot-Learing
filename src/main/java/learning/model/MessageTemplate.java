...
public class MessageTemplate implements Serializable {
    ...
    public boolean equals(Object that) {
        ...
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
            ...
            && (this.getTemplateTitle() == null ? other.getTemplateTitle() == null : this.getTemplateTitle().equals(other.getTemplateTitle()));
    }
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getTemplateTitle() == null) ? 0 : getTemplateTitle().hashCode());
        return result;
    }
