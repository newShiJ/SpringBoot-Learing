...
public class ParaManage implements Serializable {
    /**
     * uuid主键
     */
    private String id;
    ...
    /**
     * 参数类型:核心企业垫付天数范围；逾期利率，转让自动驳回天数，开单签收自动驳回天数，到期前x天提醒
     */
    ...
    /**
     * 参数使用范围
     * @param paraScope 参数使用范围
     */
    public void setParaScope(String paraScope) {
        this.paraScope = paraScope == null ? null : paraScope.trim();
    }

    /**
     * 参数类型:核心企业垫付天数范围；逾期利率，转让自动驳回天数，开单签收自动驳回天数，到期前x天提醒
     * @return para_type 参数类型:核心企业垫付天数范围；逾期利率，转让自动驳回天数，开单签收自动驳回天数，到期前x天提醒
     */
    ...
    /**
     * 参数类型:核心企业垫付天数范围；逾期利率，转让自动驳回天数，开单签收自动驳回天数，到期前x天提醒
     * @param paraType 参数类型:核心企业垫付天数范围；逾期利率，转让自动驳回天数，开单签收自动驳回天数，到期前x天提醒
     */
    ...
    public boolean equals(Object that) {
        ...
        ParaManage other = (ParaManage) that;
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
            ...
            && (this.getParaScope() == null ? other.getParaScope() == null : this.getParaScope().equals(other.getParaScope()))
            && (this.getParaType() == null ? other.getParaType() == null : this.getParaType().equals(other.getParaType()));
    }
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getParaScope() == null) ? 0 : getParaScope().hashCode());
        result = prime * result + ((getParaType() == null) ? 0 : getParaType().hashCode());
        return result;
    }
    ...
    public String toString() {
        ...
        sb.append(", paraScope=").append(paraScope);
