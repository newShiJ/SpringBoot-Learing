...
public class UserCmyPosition implements Serializable {
    /**
     * 主键uuid
     */
    private String id;
    ...
    /**
     * 手机验证码申请时间
     * @return verify_timestamp 手机验证码申请时间
     */
    ...
    /**
     * 手机验证码申请时间
     * @param verifyTimestamp 手机验证码申请时间
     */
    public void setVerifyTimestamp(String verifyTimestamp) {
        this.verifyTimestamp = verifyTimestamp == null ? null : verifyTimestamp.trim();
    }
    ...
    public boolean equals(Object that) {
        ...
        UserCmyPosition other = (UserCmyPosition) that;
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
            ...
            && (this.getRandomCode() == null ? other.getRandomCode() == null : this.getRandomCode().equals(other.getRandomCode()))
            && (this.getUserId() == null ? other.getUserId() == null : this.getUserId().equals(other.getUserId()))
            && (this.getVerifyCode() == null ? other.getVerifyCode() == null : this.getVerifyCode().equals(other.getVerifyCode()))
            && (this.getVerifyTimestamp() == null ? other.getVerifyTimestamp() == null : this.getVerifyTimestamp().equals(other.getVerifyTimestamp()));
    }
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getRandomCode() == null) ? 0 : getRandomCode().hashCode());
        result = prime * result + ((getUserId() == null) ? 0 : getUserId().hashCode());
        result = prime * result + ((getVerifyCode() == null) ? 0 : getVerifyCode().hashCode());
        result = prime * result + ((getVerifyTimestamp() == null) ? 0 : getVerifyTimestamp().hashCode());
        return result;
    }
    ...
    public String toString() {
        ...
        sb.append(", verifyTimestamp=").append(verifyTimestamp);
